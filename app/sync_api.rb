module FilesMockServer
  class SyncAPI < Grape::API
    ...
    get "/api/rest/v1/syncs" do
      status 200
      [ { "id" => 1, "name" => "example", "description" => "example", "site_id" => 1, "user_id" => 1, "src_path" => "example", "dest_path" => "example", "src_remote_server_id" => 1, "dest_remote_server_id" => 1, "two_way" => true, "keep_after_copy" => true, "delete_empty_folders" => true, "disabled" => true, "trigger" => "example", "trigger_file" => "example", "include_patterns" => [ "example" ], "exclude_patterns" => [ "example" ], "created_at" => "2000-01-01T01:00:00Z", "updated_at" => "2000-01-01T01:00:00Z", "sync_interval_minutes" => 1, "interval" => "week", "recurring_day" => 25, "schedule_days_of_week" => [ 0, 2, 4 ], "schedule_times_of_day" => [ "06:30", "14:30" ], "schedule_time_zone" => "Eastern Time (US & Canada)", "holiday_region" => "us_dc" } ]
    end
