module FilesMockServer
  class SiteAPI < Grape::API
    ...
    get "/api/rest/v1/site" do
      status 200
      { "name" => "My Site", "allowed_2fa_method_sms" => true, "allowed_2fa_method_totp" => true, "allowed_2fa_method_u2f" => true, "allowed_2fa_method_webauthn" => true, "allowed_2fa_method_yubi" => true, "allowed_2fa_method_bypass_for_ftp_sftp_dav" => true, "admin_user_id" => 1, "admins_bypass_locked_subfolders" => true, "allow_bundle_names" => true, "allowed_countries" => "US,DE", "allowed_ips" => "example", "ask_about_overwrites" => true, "bundle_activity_notifications" => "never", "bundle_expiration" => 1, "bundle_not_found_message" => "example", "bundle_password_required" => true, "bundle_recipient_blacklist_domains" => [ "example" ], "bundle_recipient_blacklist_free_email_domains" => true, "bundle_registration_notifications" => "never", "bundle_require_registration" => true, "bundle_require_share_recipient" => true, "bundle_upload_receipt_notifications" => "never", "bundle_watermark_attachment" => nil, "bundle_watermark_value" => { "key" => "example value" }, "uploads_via_email_authentication" => true, "color2_left" => "#0066a7", "color2_link" => "#d34f5d", "color2_text" => "#0066a7", "color2_top" => "#000000", "color2_top_text" => "#ffffff", "contact_name" => "John Doe", "created_at" => "2000-01-01T01:00:00Z", "currency" => "USD", "custom_namespace" => true, "days_to_retain_backups" => 30, "default_time_zone" => "Pacific Time (US & Canada)", "desktop_app" => true, "desktop_app_session_ip_pinning" => true, "desktop_app_session_lifetime" => 1, "mobile_app" => true, "mobile_app_session_ip_pinning" => true, "mobile_app_session_lifetime" => 1, "disallowed_countries" => "US,DE", "disable_files_certificate_generation" => true, "disable_notifications" => true, "disable_password_reset" => true, "domain" => "my-custom-domain.com", "domain_hsts_header" => true, "domain_letsencrypt_chain" => "example", "email" => "example", "ftp_enabled" => true, "reply_to_email" => "example", "non_sso_groups_allowed" => true, "non_sso_users_allowed" => true, "folder_permissions_groups_only" => true, "hipaa" => true, "icon128" => nil, "icon16" => nil, "icon32" => nil, "icon48" => nil, "immutable_files_set_at" => "2000-01-01T01:00:00Z", "include_password_in_welcome_email" => true, "language" => "en", "ldap_base_dn" => "example", "ldap_domain" => "mysite.com", "ldap_enabled" => true, "ldap_group_action" => "disabled", "ldap_group_exclusion" => "example", "ldap_group_inclusion" => "example", "ldap_host" => "ldap.site.com", "ldap_host_2" => "ldap2.site.com", "ldap_host_3" => "ldap3.site.com", "ldap_port" => 1, "ldap_secure" => true, "ldap_type" => "open_ldap", "ldap_user_action" => "disabled", "ldap_user_include_groups" => "example", "ldap_username" => "[ldap username]", "ldap_username_field" => "sAMAccountName", "login_help_text" => "Login page help text.", "logo" => nil, "login_page_background_image" => nil, "max_prior_passwords" => 1, "motd_text" => "example", "motd_use_for_ftp" => true, "motd_use_for_sftp" => true, "next_billing_amount" => 1.0, "next_billing_date" => "Apr 20", "office_integration_available" => true, "office_integration_type" => "example", "oncehub_link" => "https://go.oncehub.com/files", "opt_out_global" => true, "overdue" => true, "password_min_length" => 1, "password_require_letter" => true, "password_require_mixed" => true, "password_require_number" => true, "password_require_special" => true, "password_require_unbreached" => true, "password_requirements_apply_to_bundles" => true, "password_validity_days" => 1, "phone" => "555-555-5555", "pin_all_remote_servers_to_site_region" => true, "prevent_root_permissions_for_non_site_admins" => true, "require_2fa" => true, "require_2fa_stop_time" => "2000-01-01T01:00:00Z", "require_2fa_user_type" => "`site_admins`", "require_logout_from_bundles_and_inboxes" => true, "session" => { "id" => "60525f92e859c4c3d74cb02fd176b1525901b525", "language" => "en", "read_only" => true, "sftp_insecure_ciphers" => true }, "session_pinned_by_ip" => true, "sftp_enabled" => true, "sftp_host_key_type" => "default", "active_sftp_host_key_id" => 1, "sftp_insecure_ciphers" => true, "sftp_user_root_enabled" => true, "sharing_enabled" => true, "show_request_access_link" => true, "site_footer" => "example", "site_header" => "example", "smtp_address" => "smtp.my-mail-server.com", "smtp_authentication" => "plain", "smtp_from" => "me@my-mail-server.com", "smtp_port" => 25, "smtp_username" => "mail", "session_expiry" => 6.0, "session_expiry_minutes" => 360, "ssl_required" => true, "subdomain" => "mysite", "switch_to_plan_date" => "2000-01-01T01:00:00Z", "tls_disabled" => true, "trial_days_left" => 1, "trial_until" => "2000-01-01T01:00:00Z", "updated_at" => "2000-01-01T01:00:00Z", "use_provided_modified_at" => true, "user" => { "id" => 1, "username" => "user", "admin_group_ids" => [ 1 ], "allowed_ips" => "127.0.0.1", "attachments_permission" => true, "api_keys_count" => 1, "authenticate_until" => "2000-01-01T01:00:00Z", "authentication_method" => "password", "avatar_url" => "example", "billing_permission" => true, "bypass_site_allowed_ips" => true, "bypass_inactive_disable" => true, "created_at" => "2000-01-01T01:00:00Z", "dav_permission" => true, "disabled" => true, "email" => "example", "first_login_at" => "2000-01-01T01:00:00Z", "ftp_permission" => true, "group_ids" => "example", "header_text" => "User-specific message.", "language" => "en", "last_login_at" => "2000-01-01T01:00:00Z", "last_web_login_at" => "2000-01-01T01:00:00Z", "last_ftp_login_at" => "2000-01-01T01:00:00Z", "last_sftp_login_at" => "2000-01-01T01:00:00Z", "last_dav_login_at" => "2000-01-01T01:00:00Z", "last_desktop_login_at" => "2000-01-01T01:00:00Z", "last_restapi_login_at" => "2000-01-01T01:00:00Z", "last_api_use_at" => "2000-01-01T01:00:00Z", "last_active_at" => "2000-01-01T01:00:00Z", "last_protocol_cipher" => "example", "lockout_expires" => "2000-01-01T01:00:00Z", "name" => "John Doe", "company" => "ACME Corp.", "notes" => "Internal notes on this user.", "notification_daily_send_time" => 18, "office_integration_enabled" => true, "password_set_at" => "2000-01-01T01:00:00Z", "password_validity_days" => 1, "public_keys_count" => 1, "receive_admin_alerts" => true, "require_2fa" => "always_require", "require_login_by" => "2000-01-01T01:00:00Z", "active_2fa" => true, "require_password_change" => true, "password_expired" => true, "restapi_permission" => true, "self_managed" => true, "sftp_permission" => true, "site_admin" => true, "skip_welcome_screen" => true, "ssl_required" => "always_require", "sso_strategy_id" => 1, "subscribe_to_newsletter" => true, "externally_managed" => true, "time_zone" => "Pacific Time (US & Canada)", "type_of_2fa" => "yubi", "user_root" => "example", "days_remaining_until_password_expire" => 1, "password_expire_at" => "2000-01-01T01:00:00Z" }, "user_lockout" => true, "user_lockout_lock_period" => 1, "user_lockout_tries" => 1, "user_lockout_within" => 6, "user_requests_enabled" => true, "user_requests_notify_admins" => true, "welcome_custom_text" => "Welcome to my site!", "welcome_email_cc" => "example", "welcome_email_subject" => "example", "welcome_email_enabled" => true, "welcome_screen" => "user_controlled", "windows_mode_ftp" => true, "disable_users_from_inactivity_period_days" => 1, "group_admins_can_set_user_password" => true }
    end
