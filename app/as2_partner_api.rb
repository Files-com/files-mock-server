module FilesMockServer
  class As2PartnerAPI < Grape::API
    ...
    get "/api/rest/v1/as2_partners" do
      status 200
      [ { "id" => 1, "as2_station_id" => 1, "name" => "AS2 Partner Name", "uri" => "example", "server_certificate" => "require_match", "hex_public_certificate_serial" => "A5:EB:C1:95:DC:D8:2B:E7", "public_certificate_md5" => "example", "public_certificate_subject" => "example", "public_certificate_issuer" => "example", "public_certificate_serial" => "example", "public_certificate_not_before" => "example", "public_certificate_not_after" => "example" } ]
    end
