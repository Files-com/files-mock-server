module FilesMockServer
  class HistoryAPI < Grape::API
    ...
    get "/api/rest/v1/history" do
      status 200
      [ { "id" => 1, "path" => "", "when" => "2000-01-01T01:00:00Z", "destination" => "/to_path", "display" => "Actual text of the action here.", "ip" => "192.283.128.182", "source" => "/from_path", "targets" => {}, "user_id" => 1, "username" => "user", "user_is_from_parent_site" => false, "action" => "create", "failure_type" => "none", "interface" => "web" } ]
    end
