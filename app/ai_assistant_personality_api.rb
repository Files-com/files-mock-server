module FilesMockServer
  class AiAssistantPersonalityAPI < Grape::API
    ...
    get "/api/rest/v1/ai_assistant_personalities" do
      status 200
      [ { "id" => 1, "workspace_id" => 1, "system_prompt" => "Respond as a concise operations assistant.", "use_by_default" => true, "apply_to_all_workspaces" => true, "created_at" => "2000-01-01T01:00:00Z", "updated_at" => "2000-01-01T01:00:00Z" } ]
    end
