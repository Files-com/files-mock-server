module FilesMockServer
  class ExternalEventAPI < Grape::API
    ...
    get "/api/rest/v1/external_events" do
      status 200
      [ { "id" => 1, "event_type" => "", "status" => "", "body" => "", "created_at" => "2000-01-01T01:00:00Z", "body_url" => "", "folder_behavior_id" => 1, "successful_files" => 1, "errored_files" => 1, "bytes_synced" => 1, "remote_server_type" => "" } ]
    end
