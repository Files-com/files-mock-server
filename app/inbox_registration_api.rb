module FilesMockServer
  class InboxRegistrationAPI < Grape::API
    ...
    params do
      requires :inbox_code, type: String
      optional :inbox_recipient_registration_code, type: String
      optional :password, type: String
      optional :name, type: String
      optional :company, type: String
      optional :email, type: String
    end
    post "/api/rest/v1/inbox_registrations" do
      status 201
      { "code" => "abc123", "name" => "account", "company" => "Action Verb", "email" => "john.doe@files.com", "ip" => "10.1.1.1", "clickwrap_body" => "example", "form_field_set_id" => 1, "form_field_data" => { "key" => "example value" }, "inbox_id" => 1, "inbox_recipient_id" => 1, "inbox_title" => "example", "created_at" => "2000-01-01T01:00:00Z" }
    end

    params do
      requires :inbox_registration_code, type: String
    end
    post "/api/rest/v1/inbox_registrations/last_activity" do
      status 204
      body false
    end
