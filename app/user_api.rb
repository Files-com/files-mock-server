module FilesMockServer
  class UserAPI < Grape::API
    ...
    params do
      ...
      optional :ai_assistant_personality_id, type: Integer
      ...
      optional :default_workspace_id, type: Integer
      ...
      optional :primary_group_id, type: Integer
      optional :readonly_site_admin, type: Boolean
      optional :receive_admin_alerts, type: Boolean
      optional :notify_on_all_site_warnings, type: Boolean
      optional :notify_on_all_sso_failures, type: Boolean
      optional :notify_on_all_user_security_events, type: Boolean
      optional :notify_on_all_pending_work_failures, type: Boolean
      optional :notify_on_all_siem_http_destination_failures, type: Boolean
      optional :notify_on_all_sync_failures, type: Boolean
      optional :notify_on_all_automation_failures, type: Boolean
      optional :notify_on_all_expectation_failures, type: Boolean
      optional :require_login_by, type: String
      optional :require_password_change, type: Boolean
      optional :responsible_group_id, type: Integer
      optional :responsible_user_id, type: Integer
