module FilesMockServer
  class ScheduledExportAPI < Grape::API
    ...
    get "/api/rest/v1/scheduled_exports" do
      status 200
      [ { "id" => 1, "name" => "Monthly access review", "export_type" => "permission_audit", "report_name" => "Permission audit", "export_options" => { "group_by" => "user" }, "user_id" => 1, "disabled" => true, "trigger" => "daily", "interval" => "month", "recurring_day" => 1, "schedule_id" => 1, "schedule_days_of_week" => [ 1, 3, 5 ], "schedule_times_of_day" => [ "06:30" ], "schedule_time_zone" => "Eastern Time (US & Canada)", "holiday_region" => "us", "human_readable_schedule" => "Runs every month at 06:30 AM UTC TZ.", "last_run_at" => "2000-01-01T01:00:00Z", "last_export_id" => 1, "created_at" => "2000-01-01T01:00:00Z", "updated_at" => "2000-01-01T01:00:00Z" } ]
    end
