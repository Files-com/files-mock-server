module FilesMockServer
  class RemoteServerAPI < Grape::API
    ...
    get "/api/rest/v1/remote_servers/:id/configuration_file" do
      status 200
      { "id" => 1, "permission_set" => "full", "api_token" => "example", "root" => "example", "port" => 1, "hostname" => "example", "public_key" => "example", "private_key" => "example", "status" => "example", "config_version" => "example" }
    end
